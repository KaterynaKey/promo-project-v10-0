             ...
             <tr>
                <td align="center" style="padding-top: 14px; padding-bottom: 14px;">
                  <table cellpadding="0" cellspacing="0" role="presentation">
                    <tr>
                      <td align="center" style="border-radius: 10px;font-family:'Roboto', Arial, Helvetica, sans-serif;font-size:18px;font-style:normal;line-height:1.5;text-align:center;font-weight: bold; background-color: #28b628; color: #FFFFFF;" bgcolor="#28b628">
                        <a href="urlhere" target="_blank" style="font-weight: bold;text-decoration:none;color:#ffffff;background-color: #28b628;border-radius: 10px;padding: 12px 20px;display: inline-block;font-family:'Roboto', Arial, Helvetica, sans-serif;font-size:18px;font-style:normal;line-height:1.5;text-align:center;">
                          ${content}
                        </a>
                      </td>
                    </tr>
...
function cleanEmptyHtmlTags(htmlContent) {
    ...
    htmlContent = htmlContent.replace(/<u[^>]*>/gi, '').replace(/<\/u>/gi, ' ');
